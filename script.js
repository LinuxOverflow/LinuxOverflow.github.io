...
emailjs
    .send("service_u9i0ych", "template_9f31iro", params)
    .then(function () {
    ...
    .catch(function (error) {
        ...
        last.innerHTML = "Failed to send message. Please try again.";
        console.log(error);
    });
...
// Disable star animation on mobile
...
// If everything is valid → Send via EmailJS
